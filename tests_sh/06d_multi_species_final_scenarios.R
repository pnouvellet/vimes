...
params_s1s2_spatial <- c(5*rayleigh_mean)
...
# save these results
write.csv(si_res_df, "tests_sh/final_scenarios/si_95_0.75_0.5_1_100_5mean.csv")
write.csv(dist_res_df, "tests_sh/final_scenarios/dist_95_0.75_0.5_1_100_5mean.csv")
