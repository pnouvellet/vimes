...
# This script is looking at the distances
...
medians_1mil_dist = plyr::aaply(plyr::laply(comp_1mil, as.matrix), c(2, 3), median)
IQR25_1mil_dist <- plyr::aaply(plyr::laply(comp_1mil, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.25))
IQR75_1mil_dist <- plyr::aaply(plyr::laply(comp_1mil, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.75))
...
# extract the summary stats from these tables
medians_5mil_dist = plyr::aaply(plyr::laply(comp_5mil, as.matrix), c(2, 3), median)
...
# write.csv(IQR75_5mil_dist, "tests_sh/comp_dist_5mil_IQR75.csv")
...
# extract the summary stats from these tables
medians_10mil_dist = plyr::aaply(plyr::laply(comp_10mil, as.matrix), c(2, 3), median)
...
#write.csv(IQR75_10mil_dist, "tests_sh/comp_dist_10mil_IQR75.csv")
