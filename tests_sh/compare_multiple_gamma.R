# Here we are finding the difference between vimes and multiple 
...
comp_function <- function(x){
  z <- ((vimes_gamma - x)/vimes_gamma)*100
  z
}
...
medians_10k_gamma = plyr::aaply(plyr::laply(comp_10k, as.matrix), c(2, 3), median)
IQR25_10k_gamma <- plyr::aaply(plyr::laply(comp_10k, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.25))
IQR75_10k_gamma <- plyr::aaply(plyr::laply(comp_10k, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.75))
...
#write.csv(medians_10k_gamma, "tests_sh/comp_gamma_10k_medians.csv")
#write.csv(IQR25_10k_gamma, "tests_sh/comp_gamma_10k_IQR25.csv")
#write.csv(IQR75_10k_gamma, "tests_sh/comp_gamma_10k_IQR75.csv")
...
medians_100k_gamma = plyr::aaply(plyr::laply(comp_100k, as.matrix), c(2, 3), median)
IQR25_100k_gamma <- plyr::aaply(plyr::laply(comp_100k, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.25))
IQR75_100k_gamma <- plyr::aaply(plyr::laply(comp_100k, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.75))
...
#Box_100k_gamma <- plyr::aaply(plyr::laply(comp_100k, as.matrix), c(2, 3), boxplot) # would ideally need to set these to be all the same axis if to be of use 

#write.csv(medians_100k_gamma, "tests_sh/comp_gamma_100k_medians.csv")
#write.csv(IQR25_100k_gamma, "tests_sh/comp_gamma_100k_IQR25.csv")
#write.csv(IQR75_100k_gamma, "tests_sh/comp_gamma_100k_IQR75.csv")
...
medians_1mil_gamma = plyr::aaply(plyr::laply(comp_1mil, as.matrix), c(2, 3), median)
IQR25_1mil_gamma <- plyr::aaply(plyr::laply(comp_1mil, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.25))
IQR75_1mil_gamma <- plyr::aaply(plyr::laply(comp_1mil, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.75))
...
#par(mfrow = c(nrow = 5, ncol = 6))
#Box_1mil_gamma <- plyr::aaply(plyr::laply(comp_1mil, as.matrix), c(2, 3), boxplot) # would ideally need to set these to be all the same axis if to be of use 

#write.csv(medians_1mil_gamma, "tests_sh/comp_gamma_1mil_medians.csv")
#write.csv(IQR25_1mil_gamma, "tests_sh/comp_gamma_1mil_IQR25.csv")
#write.csv(IQR75_1mil_gamma, "tests_sh/comp_gamma_1mil_IQR75.csv")
...
# extract the summary stats from these tables
medians_5mil_gamma = plyr::aaply(plyr::laply(comp_5mil, as.matrix), c(2, 3), median)
IQR25_5mil_gamma <- plyr::aaply(plyr::laply(comp_5mil, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.25))
IQR75_5mil_gamma <- plyr::aaply(plyr::laply(comp_5mil, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.75))

Box_5mil_gamma <- plyr::aaply(plyr::laply(comp_1mil, as.matrix), c(2, 3), boxplot) # would ideally need to set these to be all the same axis if to be of use 

#write.csv(medians_5mil_gamma, "tests_sh/comp_gamma_5mil_medians.csv")
#write.csv(IQR25_5mil_gamma, "tests_sh/comp_gamma_5mil_IQR25.csv")
#write.csv(IQR75_5mil_gamma, "tests_sh/comp_gamma_5mil_IQR75.csv")
...
# extract the summary stats from these tables
medians_10mil_gamma = plyr::aaply(plyr::laply(comp_10mil, as.matrix), c(2, 3), median)
IQR25_10mil_gamma <- plyr::aaply(plyr::laply(comp_10mil, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.25))
IQR75_10mil_gamma <- plyr::aaply(plyr::laply(comp_10mil, as.matrix), c(2, 3), function(x)quantile(x, probs = 0.75))
